...
<div id="contenido">
  ...
  <?php if( isset( $_GET['mensaje'] ) && ! empty( $_GET['mensaje'] ) ):?>
	...
	<?php endif;?>
      <p>
  <form name="form3" method="post" action="modificar_doctor.php">
         <label for="textfield4">Buscar Doctor</label>
         <input type="text" name="buscar" placeholder="Cedula del doctor" required pattern="[0-9]{8}"/>
